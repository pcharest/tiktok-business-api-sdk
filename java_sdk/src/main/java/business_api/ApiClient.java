...
import business_api.auth.Authentication;
import business_api.auth.HttpBasicAuth;
...
@javax.annotation.Generated(value = "com.tiktok.codegen.JavatiktokcodegenGenerator", date = "2023-06-28T14:49:22.099759+05:30[Asia/Kolkata]")public class ApiClient {
  ...
  public ApiClient() {
    ...
    defaultHeaderMap.put("SDK-Version", "0.1.1");
  ...
  public List<Pair> parameterToPairs(String collectionFormat, String name, Object value){
    ...
    if (value instanceof Collection) {
      valueCollection = (Collection) value;
            ...
            else
            {
                ...
                try{
                    params.add(new Pair(name, mapper.writeValueAsString(value).replaceAll("\\{", "%7B").replaceAll("\\}", "%7D")));
                }
                catch(Exception e){
                    e.printStackTrace();
                }
    ...
    if ("multi".equals(format)) {
        ObjectMapper mapper = new ObjectMapper();
        try{
                params.add(new Pair(name, mapper.writeValueAsString(valueCollection).replaceAll("\\{", "%7B").replaceAll("\\}", "%7D")));
                }
                catch(Exception e){
                e.printStackTrace();
                }
